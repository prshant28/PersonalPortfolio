    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-6 py-4">
        <nav className="flex justify-between items-center">
          ...
          >
            <div className="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center border border-primary/30 group-hover:bg-primary/30 transition-colors">
              <Code size={18} className="text-primary" />
            </div>
            <div>
              <span className="text-primary font-alegreya font-bold text-2xl tracking-wider uppercase">
                Prashant
              </span>
              <span className="text-foreground font-alegreya text-sm tracking-widest block -mt-1">.developer</span>
            </div>
          </a>
